...
interface IRFQDeptDetailsTableProps {
    ...
    onSubmitRFQDept: () => void;   // NEW
    onCancel: () => void;          // NEW
}

const RFQDeptDetailsTable: React.FC<IRFQDeptDetailsTableProps> = ({ itemDetails, vendorOptions, handleChange, onSubmitRFQDept, onCancel }) => {
    return (
        <>
            ...
            <div className={styles.row}>
                <div className={styles.col12}>
                    <div className={styles.rgtalign}>
                        <PrimaryButton className={styles.btn} onClick={onSubmitRFQDept}>Submit</PrimaryButton>
